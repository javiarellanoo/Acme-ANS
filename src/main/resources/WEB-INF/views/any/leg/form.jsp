...
<acme:form> 
	...
	<acme:input-select code="any.leg.form.label.destinationAirport" path="destinationAirport" choices ="${destinationAirports}"/>
	...
	<acme:input-select code="any.leg.form.label.aircraft" path="aircraft" choices="${aircrafts}"/>
