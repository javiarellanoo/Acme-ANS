...
@ValidFlight
@Table(indexes = {
	@Index(columnList = "manager_id,draftMode"), @Index(columnList = "manager_id,draftMode,cost_amount,cost_currency"), @Index(columnList = "manager_id,draftMode,cost_amount")
})
